...
public class ExamsEGEFragment extends Fragment {
    ...
    private void getRetrofit() {
        ...
        Call<List<OlympicRecyclerModel>> call = service.getExamsClass(2);
        ...
        call.enqueue(new Callback<List<OlympicRecyclerModel>>() {
            ...
            public void onResponse(Call<List<OlympicRecyclerModel>> call, Response<List<OlympicRecyclerModel>> response) {
                if (!response.isSuccessful()) {
                    Log.e("ExamsEGEFragment error", "response " + response.code() + response.body());
                    return;
                }
                Log.d("ExamsEGEFragment ", "response " + response.body());

                mOlympicsList = (ArrayList<OlympicRecyclerModel>) response.body();

                initRecyclerView(mOlympicsList);
                mainTitle.setText(R.string.ege_title
            ...
            public void onFailure(Call<List<OlympicRecyclerModel>> call, Throwable t) {
                Log.e("ExamsEGEFragment ", "Error: " + t.getMessage());
            }
        });
    ...
    public static ExamsEGEFragment newInstance(String param1, String param2) {
        ExamsEGEFragment fragment = new ExamsEGEFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_exams_e_g_e, container, false);
        mProgressBar = (ProgressBar) view.findViewById(R.id.pb_ege);
        recyclerView = (RecyclerView) view.findViewById(R.id.recycler_ege);
